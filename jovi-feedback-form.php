...
Plugin URI: https://github.com/iamsandeepdahiya/Jovi-Feedback-Form
...
class Jovi_Feedback_Form {
    ...
    public static function init() {
        ...
        // Register shortcode
        add_shortcode('jovi_feedback_form', array('JOVI_Form_Handler', 'render_form'));
    }
}

// Start the plugin
Jovi_Feedback_Form::init(); 